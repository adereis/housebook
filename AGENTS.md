...
- **Trip detection heuristics**: The `detect-trips` logic prioritizes US state matches but also recognizes ISO country codes (FR, GB, BR, etc.). International trips are often higher-signal than domestic ones.
